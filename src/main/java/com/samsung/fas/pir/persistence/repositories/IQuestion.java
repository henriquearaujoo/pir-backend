...
@Repository
public interface IQuestion extends IBaseRepository<Question, Long, QQuestion> {
	@Override
	default void customize(@Nonnull QuerydslBindings bindings, @Nonnull QQuestion root) {
