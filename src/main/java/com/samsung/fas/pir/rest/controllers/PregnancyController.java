...
public class PregnancyController extends BController<PregnancyBO, PregnancyDTO> {
	...
	public ResponseEntity<?> search(@QuerydslPredicate(root = Pregnancy.class) Predicate predicate, Device device, @ApiIgnore @AuthenticationPrincipal UserDetails details) {
	...
	public ResponseEntity<?> search(@QuerydslPredicate(root = Pregnancy.class) Predicate predicate, Pageable pageable, Device device, @ApiIgnore @AuthenticationPrincipal UserDetails details) {
