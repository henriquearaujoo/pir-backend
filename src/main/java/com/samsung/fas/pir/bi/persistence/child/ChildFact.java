...
@Entity
@Table(schema = "fas_warehouse", indexes = @Index(name = "idx_child_fact", columnList = "date_id, agent_id, social_id, family_service_id, family_social_id, community_location_id, community_service_id, community_social_id", unique = true))
public class ChildFact extends BIFactBase {
	...
	private			ChildSocialDimension						social;
	// endregion
